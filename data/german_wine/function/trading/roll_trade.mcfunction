...
$data modify entity @s[tag=trade3] Offers.Recipes[$(insertion)] set value {maxUses:6,buy:{id:"minecraft:emerald",count:1},sell:{id:"minecraft:poisonous_potato",count:2,components:{"minecraft:item_name":"Riesling Grape","minecraft:lore":[{"color":"gray","text":"$(oechsle)° Oe"}],"minecraft:rarity":"common","item_model":"german_wine:white_grape","minecraft:custom_data":{gw:{riesling:1b,riesling_grape:1b,grape:1b}},"minecraft:food":{nutrition:2,saturation:0.4}}}}
tag @s[tag=trade3] add got_trade3
tag @s remove trade3

execute if score #random gw_trade matches 31..40 run tag @s[tag=!got_trade4] add trade4
$data modify entity @s[tag=trade4] Offers.Recipes[$(insertion)] set value {maxUses:6,buy:{id:"minecraft:emerald",count:1},sell:{id:"minecraft:poisonous_potato",count:2,components:{"minecraft:item_name":"Pinot Noir Grape","minecraft:lore":[{"color":"gray","text":"$(oechsle)° Oe"}],"minecraft:rarity":"common","item_model":"german_wine:red_grape","minecraft:custom_data":{gw:{pinot_noir:1b,pinot_noir_grape:1b,grape:1b}},"minecraft:food":{nutrition:2,saturation:0.4}}}}
