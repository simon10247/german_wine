...
execute unless data entity @s SelectedItem.components.minecraft:custom_data{gw_refractometer:1b} run function german_wine:debug_message/message {message:"reset_lore (fail!)"}
