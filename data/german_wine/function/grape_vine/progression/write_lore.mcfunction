...
$execute as @n[type=item_display,tag=gw_write_lore,nbt={item:{components:{"minecraft:custom_data":{gw:{diamond_refractometer:1b}}}}}] run data modify entity @s item.components.minecraft:lore append value '[{"color":"white","italic":false,"text":"Quality: "},{"color":"gray","italic":false,"text":"$(quality)"}]'
...
$execute as @n[type=item_display,tag=gw_write_lore,nbt={item:{components:{"minecraft:custom_data":{gw:{diamond_refractometer:1b}}}}}] run data modify entity @s item.components.minecraft:lore append value '[{"color":"white","italic":false,"text":"Ripening Progression: "},{"color":"gray","italic":false,"text":"$(ripening_progression)%"}]'
...
$execute as @n[type=item_display,tag=gw_write_lore,nbt={item:{components:{"minecraft:custom_data":{gw:{iron_refractometer:1b}}}}}] run data modify entity @s item.components.minecraft:lore append value '[{"color":"white","italic":false,"text":"Disease: "},{"color":"gray","italic":false,"text":"$(disease)"}]'
$execute as @n[type=item_display,tag=gw_write_lore,nbt={item:{components:{"minecraft:custom_data":{gw:{diamond_refractometer:1b}}}}}] run data modify entity @s item.components.minecraft:lore append value '[{"color":"white","italic":false,"text":"Disease: "},{"color":"gray","italic":false,"text":"$(disease) ($(disease_progression)%)"}]'
execute as @n[type=item_display,tag=gw_write_lore] run data modify entity @s item.components.minecraft:lore append value '[{"color":"white","italic":false,"text":"-------------------------------"}]'
