...
execute store result storage minecraft:german_wine vine.height int 1 run scoreboard players operation #gw_nummber_vine_height gw_nummber -= #gw_nummber_-64 gw_nummber
