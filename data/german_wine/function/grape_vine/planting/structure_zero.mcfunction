...
execute store result storage minecraft:german_wine vine_height.height int 1 run scoreboard players operation #gw_nummber_vine_height gw_nummber -= #gw_nummber_0 gw_nummber
