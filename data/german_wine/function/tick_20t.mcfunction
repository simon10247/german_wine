...
execute at @a as @e[type=villager,tag=!gw_modified_trade,distance=..20] if predicate german_wine:is_farmer_level_3 run function german_wine:trading/villager
